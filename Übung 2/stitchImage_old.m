...
%[mY,nX] = size(outputImage);

%add reference file to new output image panorama
%{
   for j =1:ySize
        for i =1:xSize
             outputImage(j+abs(getMinY),i + abs(getMinY)) = imagearray{3}(j,i);
        end
   end
%}
%outputImage = imtransform(imagearray{1}  , imtransforms{5},'XData', [(xValues1(1) + abs(getMinX)) (xValues1(2)+ abs(getMinX))], 'YData', [(yValues1(1)+ abs(getMinY)) (yValues1(2)+abs(getMinY))]);
outputImage = imtransform(imagearray{1} , imtransforms{5},'XData',[getMinX getMaxX],'YData',[getMinY getMaxY],'FillValues', NaN);
outputImageAlpha = imtransform(normAlpha , imtransforms{5},'XData',[getMinX getMaxX],'YData',[getMinY getMaxY],'FillValues', NaN);
    
outputImage2 = imtransform(imagearray{2} , imtransforms{2},'XData',[getMinX getMaxX],'YData',[getMinY getMaxY],'FillValues', NaN);
outputImageAlpha2 = imtransform(normAlpha , imtransforms{2},'XData',[getMinX getMaxX],'YData',[getMinY getMaxY],'FillValues', NaN);   

outputImage4 = imtransform(imagearray{4} , imtransforms{6},'XData',[getMinX getMaxX],'YData',[getMinY getMaxY],'FillValues', NaN);
outputImageAlpha4 = imtransform(normAlpha , imtransforms{6},'XData',[getMinX getMaxX],'YData',[getMinY getMaxY],'FillValues', NaN);

outputImage5 = imtransform(imagearray{5} , imtransforms{7},'XData',[getMinX getMaxX],'YData',[getMinY getMaxY],'FillValues', NaN);
outputImageAlpha5 = imtransform(normAlpha , imtransforms{7},'XData',[getMinX getMaxX],'YData',[getMinY getMaxY],'FillValues', NaN);

[sizeY5,sizeX5,sizeZ5] = size(outputImage5);

outputImage3 =  imtransform(imagearray{3} , maketform('projective',[1,0,0;0,1,0;0,0,1]),'XData',[getMinX getMaxX],'YData',[getMinY getMaxY],'FillValues', NaN); 
outputImageAlpha3 = imtransform(normAlpha , maketform('projective',[1,0,0;0,1,0;0,0,1]),'XData',[getMinX getMaxX],'YData',[getMinY getMaxY],'FillValues', NaN);

finaloutputimage = outputImage+ outputImage2 + outputImage4 +outputImage5 + outputImage3;


figure;
imshow(outputImageAlpha);
figure;
imshow(outputImageAlpha4);
...
%calculate output color and logical index
outputImageLogical = ~isnan(outputImage);
outputImageLogical = outputImageLogical(:,:,1);
outputImageAlphaLogical = ~isnan(outputImageAlpha);

outputImageLogical2 = ~isnan(outputImage2);
outputImageLogical2 = outputImageLogical2(:,:,1);
outputImageAlphaLogical2 = ~isnan(outputImageAlpha2);

outputImageLogical3 = ~isnan(outputImage3);
outputImageLogical3 = outputImageLogical3(:,:,1);
outputImageAlphaLogical3 = ~isnan(outputImageAlpha3);

outputImageLogical4 = ~isnan(outputImage4);
outputImageLogical4 = outputImageLogical4(:,:,1);
outputImageAlphaLogical4 = ~isnan(outputImageAlpha4);

outputImageLogical5 = ~isnan(outputImage5);
outputImageLogical5 = outputImageLogical5(:,:,1);
outputImageAlphaLogical5 = ~isnan(outputImageAlpha5);


out1 = zeros(sizeY5,sizeX5,3);
%{
%TRY3
